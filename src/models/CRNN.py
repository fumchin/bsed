...
class CRNN_DA(nn.Module):
    ...
    def __init__(self, n_in_channel, nclass, attention=False, activation="Relu", dropout=0,
        ...
        self.dropout = nn.Dropout(dropout)
        self.discriminator = Frame_Discriminator(input_dim=256, dropout=0.5)
    ...
    def forward(self, x):
        ...
        x = self.dropout(x)
        d_input = x 
        domain_pred = self.discriminator(d_input)
        return x, d_input, domain_pred
...
#             nn.BatchNorm2d(256),
#             nn.ReLU(),
#             nn.MaxPool2d(kernel_size=3, stride=(1, 4), padding=(1, 0))
#         )
...
#         )
#         # stem blocks
#         # self.stem1 = nn.Conv2d(in_channels=n_in_channel, out_channels=16, kernel_size=7, stride=1, padding=3) 
#         # self.stem2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=7, stride=1, padding=3) 
#         # self.avgpooling1 = nn.AvgPool2d((2, 1))
#         # self.glu = nn.GLU()
...
#         # # residual conv block
#         # self.rc1_1 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, stride=1, padding=1)
#         # self.rc1_2 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1)
        
#         # self.rc2_1 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1)
#         # self.rc2_2 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)

#         # self.rc3_1 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
#         # self.rc3_2 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)

#         # self.rc4_1 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
#         # self.rc4_2 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
        
#         # self.rc5_1 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
#         # self.rc5_2 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)

#         # self.avgpooling2 = nn.AvgPool2d((1, 2))
#         # self.cbam1 = CBAM(64)
#         # self.cbam2 = CBAM(128)
        
#         self.rnn = BidirectionalGRU(256, 128, dropout=dropout_recurrent, num_layers=n_layers_RNN)
